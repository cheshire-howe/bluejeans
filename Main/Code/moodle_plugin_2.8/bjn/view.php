...
$PAGE->requires->css(new moodle_url('/blocks/bjn/vendor/jquery-ui.min.css'));
$PAGE->requires->css(new moodle_url('/blocks/bjn/vendor/bootstrap.min.css'));
$PAGE->requires->js(new moodle_url('/blocks/bjn/vendor/jquery.min.js'));
...
$toform['timezone'] = 'America/Los_Angeles';//usertimezone();
$bjn->set_data($toform);
...
// If the user tries to save data
    ...
    if ($id) {
        ...
        if ($viewpage) {
            ...
            js::load('success');
            js::call('success', 'init', [$success]);
            js::load('lib');
            js::call('lib', 'toggleMeetingInfo');
        } else {
            ...
            $PAGE->requires->js(new moodle_url('/blocks/bjn/vendor/jquery-ui.min.js'));
            $PAGE->requires->js(new moodle_url('/blocks/bjn/vendor/bootstrap.min.js'));
            js::load('modal');
            js::call('modal', 'init', [$userinfo]);
            js::load('recurring');
            js::call('recurring', 'init');
