...
<bbNG:genericPage>
	...
	<bbNG:jsFile href="resources/js/build/recurring.js" />
	<bbNG:jsFile href="resources/js/build/modal.js" />
	
	<bbNG:jsBlock>
		<script type="text/javascript">
			app.recurring.init();
		    app.modal.init(${ users }, ${ attendees });
		</script>
	</bbNG:jsBlock>
	
	<bbNG:pageHeader instructions="Here you can update a video conference with students.">
		<bbNG:breadcrumbBar environment="COURSE" navItem="course_plugin_manage">
			...
			<bbNG:breadcrumb>Virtual Classroom - Update a Class</bbNG:breadcrumb>
		</bbNG:breadcrumbBar>
		<bbNG:pageTitleBar iconUrl="/images/ci/icons/tools_u.gif"
			showTitleBar="true" title="Virtual Classroom - Update a Class" />
	</bbNG:pageHeader>
	...
	<bbNG:form action="" method="post" nonceId="/update" id="bjnform">
		...
		<bbNG:dataCollection>
			<bbNG:step title="Step One">
				<bbNG:dataElement label="Class Title" isRequired="true" labelFor="title">
					<bbNG:textElement name="title" value="${ meeting.title }" isRequired="true" title="Title" />
				</bbNG:dataElement>
			...
			<bbNG:step title="Step Two">
				<bbNG:dataElement label="Start Time" isRequired="true" labelFor="start">
					<bbNG:datePicker baseFieldName="start" isRequired="true" showTime="true" dateTimeValue="${ times.start }" />
				</bbNG:dataElement>
				<bbNG:dataElement label="End Time" isRequired="true" labelFor="end">
					<bbNG:datePicker baseFieldName="end" isRequired="true" showTime="true" dateTimeValue="${ times.end }" />
				</bbNG:dataElement>
				<input type="hidden" name="start" />
				<input type="hidden" name="end" />
				<bbNG:dataElement label="Repeat" labelFor="repeat" id="use_repeat_meeting">
					<!-- <c:choose>
					    <c:when test="${meeting.recurrencePattern==null}">
					        <bbNG:checkboxElement name="repeat" value="true" isSelected="false" />
					    </c:when>    
					    <c:otherwise>
					        <bbNG:checkboxElement name="repeat" value="true" isSelected="true" />
					    </c:otherwise>
					</c:choose> -->
			        <bbNG:checkboxElement name="repeat" value="true"
			        	isSelected="${ meeting.recurrencePattern==null ? 'false' : 'true'}" />
				</bbNG:dataElement>
			...
			<bbNG:step title="Step Three">
				<bbNG:dataElement label="Add Participant Passcode"
					...
					<bbNG:checkboxElement name="addAttendeePasscode" value="true"
			        	isSelected="${ meeting.addAttendeePasscode==false ? 'false' : 'true'}" />
				</bbNG:dataElement>
			</bbNG:step>
			...
			<bbNG:step title="Step Five">
				...
				<bbNG:dataElement label="Moderator-less Class"
					...
					<bbNG:checkboxElement name="advancedMeetingOptions.moderatorLess" value="true"
			        	isSelected="${ meeting.advancedMeetingOptions.moderatorLess==false ? 'false' : 'true'}" />
				</bbNG:dataElement>
				<bbNG:dataElement label="Enable Auto-Recording"
					labelFor="autoRecord">
					<bbNG:checkboxElement name="advancedMeetingOptions.autoRecord" value="true"
			        	isSelected="${ meeting.advancedMeetingOptions.autoRecord==false ? 'false' : 'true'}" />
				</bbNG:dataElement>
				<bbNG:dataElement label="Disable Chat Messaging"
					labelFor="disallowChat">
					<bbNG:checkboxElement name="advancedMeetingOptions.disallowChat" value="true"
			        	isSelected="${ meeting.advancedMeetingOptions.disallowChat==false ? 'false' : 'true'}" />
				</bbNG:dataElement>
				<bbNG:dataElement label="Silent Participant Entry Mode"
					labelFor="muteParticipantsOnEntry">
					<bbNG:checkboxElement name="advancedMeetingOptions.muteParticipantsOnEntry" value="true"
			        	isSelected="${ meeting.advancedMeetingOptions.muteParticipantsOnEntry==false ? 'false' : 'true'}" />
				</bbNG:dataElement>
			</bbNG:step>
			<bbNG:stepSubmit />
		</bbNG:dataCollection>
